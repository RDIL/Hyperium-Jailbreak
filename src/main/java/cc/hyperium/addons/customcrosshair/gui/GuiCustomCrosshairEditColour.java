...
public class GuiCustomCrosshairEditColour extends CustomCrosshairScreen {
    ...
    public void initGui() {
        ...
        this.itemList.add(this.slider_red = new CCSlider(this, 1, "Red", 0, 0, 255, 10, 0, 255)
            .setCallback(() -> this.editColour = new Color(this.slider_red.getValue(), this.editColour.getGreen(), this.editColour.getBlue(), this.editColour.getAlpha())));
        ...
        this.itemList.add(this.slider_green = new CCSlider(this, 2, "Green", 0, 0, 255, 10, 0, 255)
            .setCallback(() -> this.editColour = new Color(this.editColour.getRed(), this.slider_green.getValue(), this.editColour.getBlue(), this.editColour.getAlpha())));
        ...
        this.itemList.add(this.slider_blue = new CCSlider(this, 3, "Blue", 0, 0, 255, 10, 0, 255)
            .setCallback(() -> this.editColour = new Color(this.editColour.getRed(), this.editColour.getGreen(), this.slider_blue.getValue(), this.editColour.getAlpha())));
        ...
        this.itemList.add(this.slider_opacity = new CCSlider(this, 4, "Opacity", 0, 0, 255, 10, 0, 255)
            .setCallback(() -> this.editColour = new Color(this.editColour.getRed(), this.editColour.getGreen(), this.editColour.getBlue(), this.slider_opacity.getValue())));
        ...
        for (int i = 0; i < this.itemList.size(); ++i) {
            if (i > 0) y += this.itemList.get(i - 1).getHeight() + 6;
