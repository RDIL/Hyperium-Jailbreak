...
public class GuiScreenKeystrokes extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(this.mc.fontRendererObj, "  KeystrokesMod  ", this.width / 2, 5, Color.WHITE.getRGB());
        drawCenteredString(this.mc.fontRendererObj, "=================", this.width / 2, 16, Color.WHITE.getRGB());
        drawCenteredString(this.mc.fontRendererObj, "Jailbreak Edition", this.width / 2, 27, Color.WHITE.getRGB());
